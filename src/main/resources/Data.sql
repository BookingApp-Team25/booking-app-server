...
VALUES
    ('123e4567-e89b-12d3-a456-426614174001', 'Cozy Studio', 'A small and comfortable studio in the city center', '423e4567-e89b-12d3-a456-426614174001', 1, 2, 'Studio', '323e4567-e89b-12d3-a456-426614174001', '523e4567-e89b-12d3-a456-426614174001', 80.0, 30, 'Manually', 'APPROVED');

-- Accommodation 2
INSERT INTO accommodation (id, name, description, location_id, min_guests, max_guests, type, availability_id, pricelist_id, price, days_before, policy, on_hold_status)
VALUES
    ('223e4567-e89b-12d3-a456-426614174001', 'Spacious Apartment', 'A large apartment with a beautiful view', '523e4567-e89b-12d3-a456-426614174001', 2, 4, 'Apartment', '423e4567-e89b-12d3-a456-426614174001', '623e4567-e89b-12d3-a456-426614174001', 120.0, 45, 'Auto', 'WAITING_FOR_CREATE_APPROVAL');
